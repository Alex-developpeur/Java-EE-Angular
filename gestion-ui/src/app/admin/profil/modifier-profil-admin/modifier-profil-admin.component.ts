...
export class ModifierProfilAdminComponent implements OnInit {
	...
	updateAuthAdmin() {
        ...
        sessionStorage.setItem(this.SESSION_ATTRIBUTE_LOGIN, this.administrateur.email);
        if(this.ancienMotDePasse !== this.administrateur.mdp) {
	        sessionStorage.setItem(this.SESSION_ATTRIBUTE_PASSWORD, this.administrateur.mdp);
        }
